"""Faithful table-entries-exact-ternary-bmv2 in P4Py DSL.

1:1 translation of p4lang/p4c testdata/p4_16_samples/table-entries-exact-ternary-bmv2.p4.

See the original:
https://github.com/p4lang/p4c/blob/main/testdata/p4_16_samples/table-entries-exact-ternary-bmv2.p4
"""
...
def ingress(hdr, meta, std_meta):
    ...
    t_exact_ternary = p4.table(
        ...
        default_action=a,
        const_entries={
            (p4.hex(0x01), p4.mask(0x1111, 0xF)): a_with_control_params(1),
            (p4.hex(0x02), p4.hex(0x1181)): a_with_control_params(2),
            (p4.hex(0x03), p4.mask(0x1111, 0xF000)): a_with_control_params(3),
